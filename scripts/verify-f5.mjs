...
const DOCS_TREE_OPS_MARKERS = [
  ...
  { file: 'src/docs/docTreeCommands.ts', tokens: ['runCreateChildDoc', 'runDocTreeAction', "case 'rename'", "case 'move'"] },
  ...
  { file: 'webview-ui/src/shared/components/DocTreeActionBar.tsx', tokens: ['ensureSummaryDoc', 'renameDoc', 'moveDoc', 'onAction'] },
